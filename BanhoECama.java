...
public class BanhoECama extends produto {
private int modelo, categoria;
	public BanhoECama(int codigo, float valor, int tipo, int estoque, int quantidadeCompra, int modelo, int categoria) {
		super(codigo, valor, tipo, estoque, quantidadeCompra);
		this.modelo = modelo;
		this.categoria = categoria;
		
	}
	//aqui ficam os acessórios de banho e cama//

...
public class Acessorios extends produto {
	...
	public Acessorios(int codigo, float valor, int tipo, int estoque, int quantidadeCompra, int modelo, int categoria) {
		super(codigo, valor, tipo, estoque, quantidadeCompra);
		this.modelo = modelo;
		this.categoria = categoria;
		
	}
//aqui são os acessórios//

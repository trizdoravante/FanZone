...
public class Blusas extends produto {
	...
	public Blusas(int codigo, float valor, int tipo, int estoque, int quantidadeCompra, int tamanho, int categoria) {

...
public class Decoracao extends produto {
	...
	public Decoracao(int codigo, float valor, int tipo, int estoque, int quantidadeCompra, int modelo, int categoria) {
		super(codigo, valor, tipo, estoque, quantidadeCompra);
		this.modelo = modelo;
		this.categoria = categoria;
	
	}
	//coisas para decoração//
